        ...
        <>
                ...
                <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
                    <div class="wrapper wrapper--w680">
                        <div class="card card-1">
                            ...
                            <div class="card-body">
                                <h2 class="title">Please enter your name and pick the Sectors you are currently involved in.</h2>
                                            ...
                                            <div class="input-group">
                                                <div class="rs-select2 js-select-simple select--no-search ">
                                                    <select class=" border-0 w-100" name="gender" {...register("Sectors", {
                                                        ...
                                                        <option disabled="disabled" selected="selected">Sectors</option>
            ...
            < div className="container all-order-container" >
                <div className="text-center pb-3">
                    {/* <h1 className="mb-5 text-center pt-5">Your Ordered <span className="text-danger">{employs.length}</span>  Products....!!!!!</h1> */}
                </div>
                {/* 
                ...
                <table className="table table-dark" style={{ width: "100%" }}>
                    ...
                    <tbody >
                        ...
                        {employs?.map((Sector, index) => (
                            <tr key={Sector._id} role="row" style={{ border: "2px solid gray" }} >
                                <th scope="row">{index + 1}</th>
                                <td>{Sector.Name}</td>
                                <td>{Sector.Sectors}</td>
                                <td>Yes</td>
                                <td>
                                    <button className='btn btn-danger' onClick={() => handleDeleteRequest(Sector._id)}> DELETE</button>

                                    {/* <button data-bs-toggle="modal"
                                        data-bs-target="#EditModal"
                                        onClick={() => handleEditEmploy(Sector)}
